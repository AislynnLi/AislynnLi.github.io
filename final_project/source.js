 ...
 */
 const Canvas2Image = (function () {
    ...
    function saveFile(strData, fileType, fileName = "Your_Chinese_Characters") {
...
//    $cursor.cursor.style.left = (e.pageX - cursorOffset.left) + 'px';
//    $cursor.cursor.style.top = (e.pageY - cursorOffset.top) + 'px';
